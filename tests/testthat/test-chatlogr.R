...
test_that("works with actual data", {
    ...
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = "mpg", chat_cols = "cyl"), 2)
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = c("mpg"), chat_cols = c("cyl", "gear")), 3)
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = c("mpg", "x"), chat_cols = c("cyl", "gear", "x")), 3)
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs"), chat_cols = c("cyl", "gear", "x")), 3)
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs"), chat_cols = c("cyl", "gear", "x", "gear")), 3)
    expect_length(read_relevant_data_columns(csv_file, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs", "mpg"), chat_cols = c("cyl", "gear", "x", "gear")), 3)
    ...
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = "mpg", chat_cols = "cyl"), 2)
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = c("mpg"), chat_cols = c("cyl", "gear")), 3)
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = c("mpg", "x"), chat_cols = c("cyl", "gear", "x")), 3)
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs"), chat_cols = c("cyl", "gear", "x")), 3)
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs"), chat_cols = c("cyl", "gear", "x", "gear")), 3)
    expect_length(read_relevant_data_columns(dat = x, idcol = "hp", chat_col_patterns = c("mpg", "x", "vs", "mpg"), chat_cols = c("cyl", "gear", "x", "gear")), 3)
